...
export default function Section2() {
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2  py-15  ">
      ...
      />
      <div className="flex justify-center flex-col gap-4  max-w-[800px] p-5">
      ...
      <div className="flex justify-center lg:text-right  lg:ml-auto flex-col gap-4  max-w-[800px] row-start-4 lg:row-start-2 p-5">
